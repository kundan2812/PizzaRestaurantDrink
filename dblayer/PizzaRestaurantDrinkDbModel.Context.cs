...
namespace dblayer
{
    ...
    public partial class Pro_PizzResturentandDrinkDbEntities : DbContext
    {
        public Pro_PizzResturentandDrinkDbEntities()
            : base("name=Pro_PizzResturentandDrinkDbEntities")
        {
        }
